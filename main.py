...
class Bank(ABC):
    """ An abstract bank class
        ...
        1. This class is derived from class ABC
        2. basicinfo() function that prints out "This is a generic bank" and
           returns the string "Generic bank: 0" 
        3. Defined a second function called withdraw and keep it empty by
           adding the `pass` keyword under it. This function is abstract by
...
class Swiss(Bank):
    ...
    [IMPLEMENT ME]
        1. This class derives from class Bank
        2. Created a constructor for this class that initializes a class
           variable `bal` to 1000
        3. Implemented the basicinfo() function so that it prints "This is the 
